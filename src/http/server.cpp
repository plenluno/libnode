...
class ServerImpl : public FlagMixin, public Server {
 ...
 private:
    ...
    class SocketOnData : LIBJ_JS_FUNCTION(SocketOnData)
     public:
        ...
        virtual Value operator()(JsArray::Ptr args) {
            ...
            if (bytesParsed < 0) {
                libj::Error::Code err = libj::Error::ILLEGAL_DATA_FORMAT;
                socket_->destroy(libj::Error::create(err));
                return err;
    ...
    class ParserOnIncoming : LIBJ_JS_FUNCTION(ParserOnIncoming)
     public:
        ...
        virtual Value operator()(JsArray::Ptr args) {
            ...
            String::CPtr expectHeader = in->getHeader(LHEADER_EXPECT);
    ...
    class ServerOnClientError : LIBJ_JS_FUNCTION(ServerOnClientError)
     public:
        virtual Value operator()(JsArray::Ptr args) {
            libj::Error::CPtr err = args->getCPtr<libj::Error>(0);
            net::SocketImpl* conn = NULL;
            to<net::SocketImpl*>(args->get(1), &conn);
 ...
 private:
    ...
    ServerImpl()
        ...
        , maxHeadersCount_(0) {
        server_->setFlag(net::ServerImpl::ALLOW_HALF_OPEN);
    }
